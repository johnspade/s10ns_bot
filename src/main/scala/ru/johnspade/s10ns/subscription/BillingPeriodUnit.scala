...
sealed abstract class BillingPeriodUnit(val chronoUnit: ChronoUnit, val measureUnit: MeasureUnit) extends EnumEntry

object BillingPeriodUnit
    extends Enum[BillingPeriodUnit]
    with CirceEnum[BillingPeriodUnit]
    with DoobieEnum[BillingPeriodUnit] {
