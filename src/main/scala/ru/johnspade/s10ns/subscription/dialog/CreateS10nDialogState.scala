...
object CreateS10nDialogState extends Enum[CreateS10nDialogState] with CirceEnum[CreateS10nDialogState] {
  ...
  case object BillingPeriodUnit
      extends CreateS10nDialogState(Messages.BillingPeriodUnit, Markup.BillingPeriodUnitReplyMarkup.some)
